...
function App() {
  return (
    <>
      ...
      <Link to="/blog">
        <div className="w-full bg-accent-purple-100 hover:bg-gradient-to-r from-accent-purple-100 via-accent-purple-200 to-accent-purple-100 animated-background py-1 flex justify-center items-center">
