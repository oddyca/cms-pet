...
export default function Button({
  ...
  const btnClass =
    bg === undefined
      ? 'flex gap-2 items-center justify-center rounded px-4 py-1 border border-1 border-black bg-white disabled:opacity-55 hover:border-gray-400 hover:brightness-105 shadow-centrif'
